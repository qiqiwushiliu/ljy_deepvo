...
if __name__ == '__main__':
	...
	for folder in train_video:
		image_path_list += glob.glob('/data3/LXT/LJY/KITTI_20241217_142029/images/{}/*.png'.format(folder))
	calculate_rgb_mean_std(image_path_list, minus_point_5=True)

# rm -f /home/LXT/LJY/DeepVO-pytorch/poses/*.npy
# rm -f /home/LXT/LJY/DeepVO-pytorch/datainfo/*.pickle