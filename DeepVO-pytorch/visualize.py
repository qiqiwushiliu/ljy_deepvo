...
pose_GT_dir = par.pose_dir  #'/home/LXT/LJY/DeepVO-pytorch/poses/'
# par.model_suffix = '_lstm'  # 或 '_cfc'
par.model_suffix = '_cfc'  # 或 '_cfc'
predicted_result_dir = '/home/LXT/LJY/DeepVO-pytorch/results/test{}/'.format(par.model_suffix)
gradient_color = True
